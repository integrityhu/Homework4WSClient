...
public class MNBArfolyamServiceSoapImplLocator extends org.apache.axis.client.Service implements hu.mnb.www.webservices.MNBArfolyamServiceSoapImpl {
    ...
    public hu.mnb.www.webservices.MNBArfolyamServiceSoap getCustomBinding_MNBArfolyamServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            hu.mnb.www.webservices.CustomBinding_MNBArfolyamServiceSoapStub _stub = new hu.mnb.www.webservices.CustomBinding_MNBArfolyamServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (hu.mnb.www.webservices.MNBArfolyamServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                hu.mnb.www.webservices.CustomBinding_MNBArfolyamServiceSoapStub _stub = new hu.mnb.www.webservices.CustomBinding_MNBArfolyamServiceSoapStub(new java.net.URL(CustomBinding_MNBArfolyamServiceSoap_address), this);
                _stub.setPortName(getCustomBinding_MNBArfolyamServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.mnb.hu/webservices/", "MNBArfolyamServiceSoapImpl");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.mnb.hu/webservices/", "CustomBinding_MNBArfolyamServiceSoap"));
        }
